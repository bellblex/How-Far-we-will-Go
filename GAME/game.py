...
def game_loop(screen, screen_width, screen_height, test_font):
    ...
    for i in range(1, 17):  # 16 idle frames
        image = pygame.image.load(f'C:/Users/eduar/OneDrive/Desktop/Du/Projetos/GameGonca/png/Idle ({i}).png').convert_alpha()
        image = pygame.transform.scale(image, (100, 100))
    ...
    for i in range(1, 16):  # Assuming there are 16 idle frames
